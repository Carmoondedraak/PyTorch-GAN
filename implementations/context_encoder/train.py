...
parser.add_argument('--val_list', default='CelebA/Anno/new_labels_val.txt', type=str, metavar='PATH',
...
def main():
    ...
    val_loader = torch.utils.data.DataLoader(
        ImageList(root=args.root_path, fileList=args.val_list,path= 'val',
            transform=transforms.Compose([
